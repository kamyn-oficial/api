...
setTimeout(() => {
  document.getElementsByName('state')[0].addEventListener('change', function() {
    var estado = this.value;
    var cidades = document.getElementsByName('city')[0];
    cidades.innerHTML = '';
    estados.forEach(item => {
      if (item.nome == estado) {
        item.cidades.forEach(city => {
          cidades.innerHTML += '<option value="' + city + '">' + city + '</option>';
        })
      }
    })
})
